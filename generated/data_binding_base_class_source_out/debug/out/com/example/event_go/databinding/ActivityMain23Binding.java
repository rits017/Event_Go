...
public final class ActivityMain23Binding implements ViewBinding {
  ...
  private ActivityMain23Binding(@NonNull ConstraintLayout rootView, @NonNull Button b231,
      @NonNull TextView tv231) {
  ...
  public static ActivityMain23Binding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      id = R.id.tv231;
      TextView tv231 = ViewBindings.findChildViewById(rootView, id);
      if (tv231 == null) {
        break missingId;
      }

      return new ActivityMain23Binding((ConstraintLayout) rootView, b231, tv231);
    }
